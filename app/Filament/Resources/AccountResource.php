            ...
            ->schema([
                Forms\Components\Grid::make(3)->schema([
                                    ...
                                    foreach (config('app.locales') as $locale => $language){
                                        $tabs[] = Forms\Components\Tabs\Tab::make($language)->schema([
                                            TextInput::make("title.{$locale}")
                                                ...
                                                ->unique(Account::class, "title->{$locale}", ignoreRecord: true)
                                                ->required(),
                    ...
                    Forms\Components\Grid::make(1)->schema([
                        Forms\Components\Section::make()->schema(
                            array_merge(
                                Filament::auth()->user()->can('change_author_account') ? [
            ...
            ->bulkActions([
                Tables\Actions\BulkAction::make('Change Status')
                    ...
                    ->action(function (Collection $records, $data){
                        $records->each(function(Account $record) use ($data){
