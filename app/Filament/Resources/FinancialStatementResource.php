...
class FinancialStatementResource extends Resource
{
                ...
                Forms\Components\Grid::make(3)->schema([
                    ...
                    Forms\Components\Grid::make(1)->schema([
                        Forms\Components\Section::make()->schema(
                            array_merge(
                                Filament::auth()->user()->can('change_author_financial-statement') ? [
                                ...
                                Forms\Components\Select::make('status')
                                    ->label(__("Status"))
                                    ->options(FinancialStatement::getStatuses())
                                    ->native(false)
                                    ->default(1),
        ...
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('status')
                    ...
                    ->badge()
                    ->toggleable()
                    ->color(function (FinancialStatement $record){
                        return $record->status == Utilities::PUBLISHED ? "success" : "danger";
                    })
                    ->formatStateUsing(function(FinancialStatement $record){
            ...
            ->bulkActions([
                ...
                Tables\Actions\BulkActionGroup::make([
                    ExportBulkAction::make('Export')->label(__('Export'))->exports([
                        FinancialStatementsExport::make()->fromModel()
                    ]),
    ...
    {
        return [
            'index' => \App\Filament\Resources\FinancialStatementResource\Pages\ListFinancialStatements::route('/'),
            'create' => \App\Filament\Resources\FinancialStatementResource\Pages\CreateFinancialStatement::route('/create'),
            'edit' => \App\Filament\Resources\FinancialStatementResource\Pages\EditFinancialStatement::route('/{record}/edit'),
        ];
    }
}
