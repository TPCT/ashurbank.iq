...
class CareerWebformResource extends Resource implements HasShieldPermissions
{
    use HasForm, Translatable;

    protected static ?string $model = CareerWebform::class;
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->filters([
                Tables\Filters\SelectFilter::make('career')
                    ->relationship('career', 'title->' . app()->getLocale())
                    ->searchable()
                    ->preload()
                    ->label(__("Career")),
            ...
            ->actions([
                Tables\Actions\Action::make('view')
                    ...
                    ->modalContent(function ($record){
                        return view('filament.Careers.WebformView', ['record' => $record]);
                    })
    ...
    {
        return [
            'index' => \App\Filament\Resources\CareerWebformResource\Pages\ListCareerWebforms::route('/'),
        ];
    }
