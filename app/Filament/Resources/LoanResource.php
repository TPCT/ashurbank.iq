...
//                                                ->unique(Loan::class, "title->{$locale}", ignoreRecord: true)
                                                ->required(),
                    ...
                    Forms\Components\Grid::make(1)->schema([
                        Forms\Components\Section::make()->schema(
                            array_merge(
                                Filament::auth()->user()->can('change_author_loan') ? [
        ...
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('status')
                    ...
                    ->formatStateUsing(function(Loan $record){
