...
class CareerImport implements ToCollection, WithChunkReading, WithLimit
{
    ...
    private array $translatable = ['title', 'location', 'description', 'qualifications', 'benefits', 'desirable'];
