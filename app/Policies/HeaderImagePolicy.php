...
class HeaderImagePolicy
{
    ...
    {
        return $user->can('view_any_header-image');
    }
    ...
    {
        return $user->can('view_header-image');
    }
    ...
    {
        return $user->can('create_header-image');
    }
    ...
    {
        return $user->can('update_header-image');
    }
    ...
    {
        return $user->can('delete_header-image');
    }
    ...
    {
        return $user->can('delete_any_header-image');
    }
    ...
    {
        return $user->can('force_delete_header-image');
    }
    ...
    {
        return $user->can('force_delete_any_header-image');
    }
