...
@section('title', __('site.Transfer'))
@section('id', 'Transfer')

@section('content')
    <x-layout.header-image title="{{__('site.Transfer')}}"></x-layout.header-image>
            ...
            <section>
                <div class="container retail-container ">
                    <div class="retail-content">
                        ...
                        {!! $item->description !!}
                        <a href="{{route('transfers.show', ['section' => $section, 'transfer' => $item->slug])}}">
