        ...
        <form method="post" action="" class="py-5 px-2 px-md-4">
            ...
            <div class="d-block w-100 d-lg-none">
                ...
                >
                    <label class="as-mobile-current-progress">
                        ...
                        ></label>
                    <div class="">
                        <p class="as-mobile-current-step">@lang('site.CARD_REQ_STEP_1')</p>
                        <p class="as-mobile-next-step">
                            @lang('site.Next Step'): @lang('site.CARD_REQ_STEP_2')
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row w-100 px-2 px-sm-4 px-lg-4 gy-4 gx-3 gx-xl-4">
                <div class="col-12 col-sm-6 form-group">
                    <label for="full_name_ar" class="pb-1">@lang('site.Full Name') <span>*</span> <span class="as-label-gray">(@lang('site.In Arabic'))</span> </label>
                    <div class="has-validation input-group">
                        <input
                                ...
                                id="full_name_ar"
                                name="full_name_ar"
                                value="{{old('full_name_ar', $full_name_ar)}}"
                                required
                        />
                        @error('full_name_ar')
                ...
                <div class="col-12 col-sm-6 form-group">
                    <label for="full_name_en" class="pb-1">@lang('site.Full Name') <span>*</span> <span class="as-label-gray">(@lang('site.In English'))</span> </label>
                    <div class="has-validation input-group">
                        <input
                                type="text"
                                ...
                                id="full_name_en"
                                name="full_name_en"
                                value="{{old('full_name_en', $full_name_en)}}"
                                required
                        />
                        @error('full_name_en')
                        <div class="invalid-feedback">
