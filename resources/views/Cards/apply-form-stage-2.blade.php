    ...
    <section class="mt-5 container as-multi-steps-form-container">
        <form method="post" action="" class="py-5 px-2 px-md-4">
            ...
            <div class="d-block w-100 d-lg-none">
                ...
                >
                    <label class="as-mobile-current-progress">
                        ...
                        ></label>
                    <div class="">
                        <p class="as-mobile-current-step">@lang('site.CARD_REQ_STEP_2')</p>
                        <p class="as-mobile-next-step">
                            @lang('site.Next Step'): @lang('site.CARD_REQ_STEP_3')
                        </p>
                    </div>
                </div>
            </div>
            ...
            >
                ...
                <a href="{{route('cards.apply-step-1', ['section' => $section, 'card' => $card])}}" class="as-single-circle-container">
